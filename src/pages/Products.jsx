...
import { useLocation } from 'react-router-dom'; // Import useLocation to get the search query
...
const Products = () => {
  ...
  const queryParams = new URLSearchParams(location.search); // Get the search parameters
  const searchQuery = queryParams.get('search') || ''; // Get the search query
